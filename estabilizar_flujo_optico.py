...
# Estabilizacion con FLUJO OPTICO (version alternativa, NO es la que usamos)
# La probamos primero; la final es estabilizar.py (Fourier), que usa lo visto en clase.
# Con esta: 47 personas y 25/33 ventanas; con Fourier: ver README.
#
...
salida = sys.argv[2] if len(sys.argv) > 2 else 'video_estable_flujo.mp4'
...
np.save('movimiento_flujo.npy', movimiento)
